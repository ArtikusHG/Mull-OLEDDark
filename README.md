...
Building the entire browser from source just to change two lines in the xml resources is uneconomical (don't know if that's a real word but it gets the point across).
